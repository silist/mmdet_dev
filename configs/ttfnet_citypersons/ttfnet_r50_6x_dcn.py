...
model = dict(
    type='TTFNet',
    pretrained='models_pretrained/resnet50-19c8e357.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
log_level = 'INFO'
work_dir = './work_dirs/citypersons/ttfnet_r50_6x_dcn'
load_from = None
resume_from = None
# resume_from = './work_dirs/citypersons/ttfnet_r50_5x_dcn/latest.pth'
workflow = [('train', 1)]
