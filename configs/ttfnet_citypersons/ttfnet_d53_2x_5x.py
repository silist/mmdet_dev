...
model = dict(
    ...
    pretrained='/disk1/feigao/gits/Pedestron/models_pretrained/darknet53_pretrain-9ec35d.pth',
    backbone=dict(
        type='DarknetV3',
        layers=[1, 2, 8, 8, 4],
...
log_level = 'INFO'
# work_dir = 'work_dirs/ttfnet53_d53_2x'
work_dir = 'work_dirs/citypersons/ttfnet_d53_2x_5x'
load_from = None
resume_from = 'work_dirs/citypersons/ttfnet_d53_2x/latest.pth'
workflow = [('train', 1)]
